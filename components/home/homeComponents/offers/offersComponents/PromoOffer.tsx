    ...
    <div className="grid grid-cols-1 items-center bg-white p-8 md:grid-cols-2">
      <div className="grid gap-6 py-12 md:-mr-24 z-20">
        ...
        <p className="text-slate-900 text-xl ">
          ...
          Exercitationem eaque laboriosam libero quia possimus ea magnam quod
          deleniti molestias deserunt facere autem, modi officiis aliquam sit.
        </p>
      ...
      <Image src="/images/promo.png" width={500} alt="image" />
    </div>
  )
}
